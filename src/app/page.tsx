    ...
    <div className="bg-black text-white font-sans relative z-50" onMouseMove={Move}>
      ...
      <section id="projects" className="py-12 px-8 font-Cormorant">
        ...
        <div className="justify-items-center mt-10 grid md:grid-cols-2 gap-16">
          ...
          {Projects(["L","e","v","e","l","U","p","-","A","I"],'https://github.com/neeranjan-bhardwaj/Level-Up-v2','An intelligent roadmap generator powered by Google Gemini API, creating personalized learning paths for gaming, coding, and various skills through Next.js architecture.','/LevelUp.jpg',["Frontend Development","Backend Development","Next JS","React JS","JavaScript","ShadCN UI"],false)}

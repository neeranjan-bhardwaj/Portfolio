    ...
    <div>
        ...
        <div className='grid gap-10 mt-16'>
          <div className='flex gap-28 justify-center'>
            ...
            <div className='bg-[#ffffff7b] rounded-md drop-shadow-lg font-semibold w-36 h-9 text-2xl text-center' id='Skill'>NODE.JS</div>          </div>
          <div className='flex gap-28 justify-center'>
            ...
            <div className='bg-[#ffffff7b] rounded-md drop-shadow-lg font-semibold w-36 h-9 text-2xl text-center' id='Skill'>TAILWIND</div>
          </div>
        </div>
    </div>
  )
